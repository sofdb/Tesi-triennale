...
% stampa il campo "shorthand" del file .bib (tipo di atto, data completa, numero)
% invece della citazione autore-anno in stile APA, mantenendo comunque il
...
% Disattiva i link ipertestuali dei riferimenti al glossario nel testo
% (restano comunque riconoscibili tramite il formattatore \glstextformat)
\glsdisablehyper
