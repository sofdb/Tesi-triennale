...
\todoplaceholder{collegamento con il capitolo 1 sul rapporto tra l'azienda e l'innovazione.}
...
\todoplaceholder{inquadramento sintetico, dal punto di vista aziendale, della rilevanza dell'accessibilità digitale.}
...
% l'approfondimento tecnico e normativo completo è nel capitolo~\ref{chap:quadro-normativo}.


\section{Obiettivi e vincoli dello stage}
\label{sec:obiettivi-vincoli}

\todoplaceholder{obiettivi assegnati allo stage e vincoli posti dall'azienda.}
...
\todoplaceholder{motivazione della scelta di questo stage rispetto ad altre proposte.}
